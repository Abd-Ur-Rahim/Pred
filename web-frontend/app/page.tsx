      ...
      <Sidebar className="!bg-slate-900 !text-white border-r border-slate-700">
        ...
        <SidebarContent className="pt-4 px-2 bg-slate-900">
          <nav className="space-y-1">
            <div className="flex items-center gap-3 px-3 py-2 rounded-md bg-slate-800 text-blue-400 border-l-4 border-blue-400">
        ...
        <div className="border-b border-slate-800 bg-slate-900/50 backdrop-blur">
          <div className="px-6 py-4 flex justify-between items-center">
            <div className="flex gap-6">
              <div className="text-sm font-semibold cursor-pointer text-blue-400 border-b-2 border-blue-400 pb-1">
                DASHBOARD
              </div>
